  ...
  <div class="VuePassword">
    <div class="VuePassword__Container">
      ...
      >
        ...
        <input
          ref="input"
          :class="[classes, 'VuePassword__Input', { 'VuePassword__Input--has-toggle': !disableToggle }]"
      ...
      <slot v-if="!disableToggle" name="password-toggle" :toggle="togglePassword">
        <button class="VuePassword__Toggle" :title="toggleMessage" type="button" @click="togglePassword">
...
.VuePassword__Input:focus {
  box-shadow: inset 0px 0px 2px 2px rgba(139, 139, 139, 0.5);
  transition: 0.2s all;
  outline: none;
}
.VuePassword__Input:disabled {
