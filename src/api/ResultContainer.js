 ...
 */
export const createSuccessResult = (result, response) =>
  createResultContainer(result, null, response);
 ...
 */
export const createErrorResult = (error, response) =>
  createResultContainer(null, error, response);
